...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      ...
      <?php  } ?>
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaS" selected="selected">Categoria S</option>
  ...
  <div class="gallery">
    <div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/scream.jpg" alt="" width="2000" class="cards"/></a>
      <h4><a href="#">SCREAM</a></h4>
      <p class="tag">Depois de um incidente de cyber-bullying resultar em um assassinato brutal, a violência reacende a memória de uma série de assassinatos que ocorreram no passado<a href="#">Mais ...</a></p>
    </div>
    <div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/scream-queens.jpg" alt="" width="2000" class="cards"/></a>
