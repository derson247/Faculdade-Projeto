...
<title>Mr. Robot T03EP10 (legendado)</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       		<video width="500" autoplay controls class="cards" src="https://rc-downloads.azureedge.net/d/RCServer13/ondemand/MROBS03EP10.mp4" type="video/mp4">
			</video>
        <h4>Mr. Robot T03EP10 <strong style="color:#FF0000">Legendado</strong></h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
