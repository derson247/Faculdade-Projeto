...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      ...
      <?php  } ?>
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaR" selected="selected">Categoria R</option>
  ...
  <div class="gallery">
    <div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/Reign.jpg" alt="" width="2000" class="cards"/></a>
    ...
    <div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/rush-hour.jpg" alt="" width="2000" class="cards"/></a>
      ...
      <p class="tag">Jonathan Lee (Jon Foo), um rigoroso policial de Hong Kong, é destacado para acompanhar um caso em Los Angeles. Ele é forçado a trabalhar com um petulante agente<a href="#">Mais ...</a></p>
    </div>
  </div>
  <!-- Footer Section -->
  <footer id="contact">
