...
<div class="corp"><div align="center" class="center"><img src="images/logo2.png"/></div>
 <div class="container">
    ...
    <nav id="menu" class="container">
      ...
      <?php  } ?>
    	...
    	<select id="select" class="container" onchange="window.location=this.value">
    		...
    		<option value="categoriaV" selected="selected">Categoria V</option>
  ...
  <div class="gallery">
  	<div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/veep.jpg" alt="" width="2000" class="cards"/></a>
      	<h4><a href="#">VEEP</a></h4>
      	<p class="tag">A senadora Selina Meyer (Julia Louis-Dreyfus) integra a chapa que conquista a eleição presidencial norte-americana e assume o posto de vice-presidente dos Estados Unidos<a href="#">Mais ...</a></p>
    </div>
  	<div class="thumbnail" id="thumbnail10"><a href="#"><img src="images/vegas.jpg" alt="" width="2000" class="cards"/></a>
