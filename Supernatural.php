...
<div class="corp"><div align="center" class="center"><img alt="" src="images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
    ...
    <h4>SUPERNATURAL</h4>
		<p class="tag">Desde que era pequeno, Sam Winchester (Jared Padalecki) tentava escapar do próprio passsado. Após a misteriosa morte de Mary (Samantha Smith), o pai de Sam passou a procurar vingança contra as forças do mal que mataram a esposa, destruindo qualquer ser maligno que cruze o seu caminho. Ao contrário de Sam, Dean (Jensen Ackles), irmão mais velho, sempre quis seguir os passos do pai. Sam está determinado a se livrar do “negócio da família”, mas sua vida está prestes a tomar os rumos que ele não desejava, quando ele fica sem escolhas a não ser unir-se ao irmão.</p>
      <p class="text_column2">Criado por: McG (2005)</p>
      <p class="text_column2">Gênero: Drama, Fantasia</p>
      <p class="text_column2">País: EUA</p>
      <p class="text_column2">Atores: Jared Padalecki, Jensen Ackles, Misha Collins, mais ...</p>
  ...
  <!-- Copyrights Section -->
  <div class="copyright">&copy;2020- <strong style="color:#12E19D">VIA SÉRIE </strong></div>
	</div></div>
<!-- Main Container Ends -->
</body>
</html>
