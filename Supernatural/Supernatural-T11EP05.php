...
<title>Supernatural T11EP05</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="https://rc-downloads.azureedge.net/d/RCServer10/ondemand/SPNT11EP05.mp4" type="video/mp4">
</video>
        <h4>Supernatural T11EP05</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
