...
<title>DC's Legends Of Tomorrow T01EP01</title></head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="https://rc-downloads.azureedge.net/d/RCServer10/ondemand/LGNDSODTMRWT01EP01.mp4" type="video/mp4"></video>
        <h4>DC's Legends Of Tomorrow T01EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
