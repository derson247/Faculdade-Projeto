...
<title>The Originals T01EP15</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0B7-vyaz3VmDpQkNmZGRFa21hU3M/preview?rel=0" width="500" class="cards" allowfullscreen></iframe>
        <h4>The Originals T01EP15</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
