...
<title>The Originals T01EP12</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="https://rc-downloads.azureedge.net/d/RCServer09/ondemand/THORGNLT01EP12.mp4" type="video/mp4"></video>
        <h4>The Originals T01EP12</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
