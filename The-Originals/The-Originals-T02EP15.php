...
<title>The Originals T02EP15</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 ...
 <div class=" menu-item-43">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<iframe src="https://drive.google.com/file/d/0BxkLsWLy70H6NTRrNk0tR21MdU0/preview?rel=0" width="500" class="cards" allowfullscreen></iframe>
        <h4>The Originals T02EP15</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
