...
<title>Stranger Things T01EP04</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video controls autoplay class="cards" src="https://rc-downloads.azureedge.net/d/RCServer11/ondemand/STRNGRTHNGT01EP04.mp4"></video>
        <h4>Stranger Things T01EP04</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
