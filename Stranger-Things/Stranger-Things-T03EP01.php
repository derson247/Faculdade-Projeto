...
<title>Stranger Things T03EP01</title>
</head>
<body>
<!-- Main Container -->
<div class="corp"><div align="center" class="center"><img alt="" src="../images/logo2.png"/></div>
 <div class="container">
  ...
  <div class="gallery">
  		<div class="thumbnail">
       	<video autoplay controls  width="500" class="cards" src="https://rc-downloads.azureedge.net/d/RCServer06/ondemand/STRNGRTHNGT03EP01.mp4" type="video/mp4"></video>        
        <h4>Stranger Things T03EP01</h4>
        </div></div>
        <!-- Footer Section -->
  <footer id="contact">
